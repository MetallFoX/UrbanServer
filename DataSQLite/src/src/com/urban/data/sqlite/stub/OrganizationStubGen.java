package src.com.urban.data.sqlite.stub;

import com.urban.data.ContactType;

import java.util.*;

public class OrganizationStubGen {
    ...
    public static void main(String args[]) {
        ...
        for (OrganizationStub org : orgs) {
            System.out.printf(
                    "insert into organizations (\"id\", \"logo\", \"name\", \"description\") "
                    + "values ('%d', null, '%s', '%s');%n", i, org.name, org.desc);
            orgMap.put(org, i);

            System.out.printf(
                    "insert into places (\"id\", \"lat\", \"alt\", \"description\") "
            ...
            System.out.printf(
                    "insert into addresses (\"id\", \"street\", \"house\", \"letter\", \"floor\", \"flat\", \"place\") "
                    + "values ('%s', '%s', '%s', '%s', '%s', '%s');%n", i, org.place.address.street, org.place.address.house, org.place.address.letter, org.place.address.floor, org.place.address.flat, i);
            ...
            */
            ...
            while (iterator.hasNext()) {
                ...
                System.out.printf(
                        "insert into contacts (\"id\", \"info\", \"type\") "
