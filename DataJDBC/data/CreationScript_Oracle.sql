...
DROP TABLE Position_Page CASCADE CONSTRAINTS;
DROP TABLE Info_Page CASCADE CONSTRAINTS;
DROP TABLE Action_Page CASCADE CONSTRAINTS;
DROP TABLE Category_Position CASCADE CONSTRAINTS;
...
CREATE TABLE Position (id number(10) NOT NULL, name varchar2(255) NOT NULL, organization number(10) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Advertising (id number(10) NOT NULL, priority number(10) NOT NULL, text varchar2(255), image number(10), position number(10) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Action (id number(10) NOT NULL, startDate date, endDate date, subject varchar2(255) NOT NULL, position number(10) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Position_Page (position number(10) NOT NULL, page number(10) NOT NULL, PRIMARY KEY (position, page));
CREATE TABLE Info_Page (id number(10) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Action_Page (id number(10) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Category_Position (category number(10) NOT NULL, position number(10) NOT NULL, PRIMARY KEY (category, position));
...
ALTER TABLE Position_Page ADD CONSTRAINT FKPosition_P63049 FOREIGN KEY (position) REFERENCES Position (id);
ALTER TABLE Position_Page ADD CONSTRAINT FKPosition_P989259 FOREIGN KEY (page) REFERENCES Page (id);
...
ALTER TABLE Position ADD CONSTRAINT FKPosition350934 FOREIGN KEY (organization) REFERENCES Organization (id);
ALTER TABLE Category_Advertising ADD CONSTRAINT FKCategory_A580589 FOREIGN KEY (advertising) REFERENCES Advertising (id);
ALTER TABLE Category_Position ADD CONSTRAINT FKCategory_P674365 FOREIGN KEY (category) REFERENCES Category (id);
ALTER TABLE Category_Position ADD CONSTRAINT FKCategory_P477025 FOREIGN KEY (position) REFERENCES Position (id);
...
ALTER TABLE Action ADD CONSTRAINT FKAction875605 FOREIGN KEY (position) REFERENCES Position (id);
ALTER TABLE Advertising ADD CONSTRAINT FKAdvertisin899732 FOREIGN KEY (position) REFERENCES Position (id);
ALTER TABLE Notification_Subscribe ADD CONSTRAINT FKNotification_S415883 FOREIGN KEY (position) REFERENCES Position (id);
